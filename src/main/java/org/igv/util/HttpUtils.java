...
public class HttpUtils {
    ...
    private int getUCSCConnectTimeout() {
        ...
        return timeout > 0 ? timeout : PreferencesManager.getPreferences().getAsInt(HTTP_CONNECT_TIMEOUT);
    }
...
private HttpURLConnection openConnectionHeadOrGet(URL url) throws IOException {
    ...
    private HttpURLConnection openConnection(
        ...
        try {
            ...
            conn.setConnectTimeout(isUCSCHost(url)
                    ? getUCSCConnectTimeout()
                    : PreferencesManager.getPreferences().getAsInt(HTTP_CONNECT_TIMEOUT));
